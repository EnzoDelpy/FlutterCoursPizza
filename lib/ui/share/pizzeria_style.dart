...
class PizzeriaStyle{
  ...
  static final TextStyle pageTitleTextStyle = baseTextStyle.copyWith(fontSize: 26.0);

  static final TextStyle headerTextStyle = baseTextStyle.copyWith(fontSize: 20.0);
